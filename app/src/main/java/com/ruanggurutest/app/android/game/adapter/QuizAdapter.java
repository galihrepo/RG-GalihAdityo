package com.ruanggurutest.app.android.game.adapter;
...
public class QuizAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_WRONG) {
            View view = LayoutInflater.from(context).inflate(R.layout.game_wrong, parent, false);
            holder = new WrongViewHolder(view);

        } else if (viewType == VIEW_CORRECT) {
            View view = LayoutInflater.from(context).inflate(R.layout.game_correct, parent, false);
            holder = new CorrectViewHolder(view);

        } else {
            View view = LayoutInflater.from(context).inflate(R.layout.game_question, parent, false);
    ...
    public static class QuestionViewHolder extends RecyclerView.ViewHolder {
        ...
        public BaseTextViewMedium tvOption;
        public BaseTextViewMedium tvAnswerChoice;
        public BaseTextViewMedium tvChoice;
        public BaseTextViewRegular tvChoiceRemarks;
